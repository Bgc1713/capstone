...
//		System.out.println(test_mtx2.toString());
		...
		test_mtx.setItem(1, 1, 2);
		test_mtx.setItem(1, 2, -4);
		test_mtx.setItem(1, 3, 2);
		test_mtx.setItem(2, 1, 1);
		test_mtx.setItem(2, 2, 5);
		test_mtx.setItem(2, 3, -4);
		test_mtx.setItem(3, 1, -6);
		test_mtx.setItem(3, 2, -2);
		test_mtx.setItem(3, 3, 4);
		...
		ttest_mtx.setItem(1, 1, 0);
		ttest_mtx.setItem(1, 2, 2);
	    ttest_mtx.setItem(1, 3, 8);
	    ttest_mtx.setItem(1, 4, 0);
		ttest_mtx.setItem(2, 1, 1);
		ttest_mtx.setItem(2, 2, 3);
		ttest_mtx.setItem(2, 3, 5);
	    ttest_mtx.setItem(2, 4, 2);
		ttest_mtx.setItem(3, 1, 2);
		ttest_mtx.setItem(3, 2, 1);
		ttest_mtx.setItem(3, 3, 0);
	    ttest_mtx.setItem(3, 4, -3);
		ttest_mtx.setItem(4, 1, 2);
		ttest_mtx.setItem(4, 2, -5);
		ttest_mtx.setItem(4, 3, -2);
	    ttest_mtx.setItem(4, 4, -7);
